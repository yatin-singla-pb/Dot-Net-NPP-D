...
BEGIN
    ...
    INSERT INTO proposal_types (Id, Name, IsActive) VALUES
                    (1,'New Contract',1),(2,'Amendment',1)
                    ON DUPLICATE KEY UPDATE Name=VALUES(Name), IsActive=VALUES(IsActive);
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20251015110528_UpdateProposalProductFields') THEN

    ALTER TABLE `ProposalProducts` DROP COLUMN `PackingList`;
...
BEGIN
    ...
    ALTER TABLE `ProposalProducts` RENAME COLUMN `ProposedPrice` TO `CommodityFobPrice`;
...
BEGIN
    ...
    ALTER TABLE `ProposalProducts` ADD `Allowance` decimal(18,4) NULL;
...
BEGIN
    ...
    ALTER TABLE `ProposalProducts` ADD `BillbacksAllowed` tinyint(1) NOT NULL DEFAULT FALSE;
...
BEGIN
    ...
    ALTER TABLE `ProposalProducts` ADD `CommercialDelPrice` decimal(18,4) NULL;
...
BEGIN
    ...
    ALTER TABLE `ProposalProducts` ADD `CommercialFobPrice` decimal(18,4) NULL;
...
BEGIN
    ...
    ALTER TABLE `ProposalProducts` ADD `CommodityDelPrice` decimal(18,4) NULL;
...
BEGIN
    ...
    ALTER TABLE `ProposalProducts` ADD `ManufacturerNotes` varchar(1000) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `ProposalProducts` ADD `Uom` varchar(20) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20251015110528_UpdateProposalProductFields', '9.0.9');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20251028000100_AddRejectReasonToProposals') THEN

    ALTER TABLE `proposals` ADD `RejectReason` varchar(1000) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20251028000100_AddRejectReasonToProposals', '9.0.9');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20251030130414_RemoveDistributorPriceFromDistributorProductCodes') THEN
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20251030130414_RemoveDistributorPriceFromDistributorProductCodes', '9.0.9');
